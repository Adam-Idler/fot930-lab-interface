					...
					<div className="p-6">
						...
						<div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
							...
							<p className="text-xs text-emerald-700 leading-relaxed">
								...
								компонентов, соединённых последовательно (например: магистральный
								кабель → сплиттер → абонентский кабель). При сборке схемы для
								такого сценария все компоненты цепи размещаются между тестерами
								в правильном порядке. Измерение отражает суммарные потери всей
								цепи, а сплиттер в составе сценария также измеряется по каждому
								выходу отдельно.
							</p>
						</div>
					</div>
				...
				<div className="bg-white rounded-lg shadow-md overflow-hidden">
					...
					<div className="p-6">
						<p className="text-sm text-gray-600 mb-4">
							...
							километрическое затухание. По завершении таблицы необходимо сделать
						...
						<div className="bg-violet-50 border border-violet-200 rounded-lg p-4">
							<div className="text-sm text-violet-800">
								Вопрос об исправности появляется автоматически после того, как все
								ячейки таблицы заполнены. Без ответа на этот вопрос компонент считается неизмеренным.
							</div>
						</div>
					</div>
				</div>
