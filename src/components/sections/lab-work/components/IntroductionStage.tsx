					...
					<div className="p-6">
						...
						<div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 mb-3">
							...
							<p className="text-xs text-emerald-700 leading-relaxed">
								...
								отдельно. Например, для сплиттера 1:4 выполняется 4 отдельных
								измерения — по одному на каждый выход. Активный выход
			...
			<div className="bg-white rounded-lg shadow-md overflow-hidden">
				...
				<div className="p-6">
					<p className="text-sm text-gray-600 mb-4">
						...
						последовательно выполнить все шаги диагностики. Данный этап доступен
						только после измерения потерь всех доступных компонентов на
						предыдущем этапе.
					</p>
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
						<StepCard
				...
				<div className="p-6">
					...
					<ul className="flex flex-col gap-2">
						{[
							...
							'Фотография / скриншот выполненного этапа подготовки прибора к работе',
							...
							'Фотография / скриншот экрана с результатами по проделанной работе (необходимо нажать по имени в верхней панели программы)',
