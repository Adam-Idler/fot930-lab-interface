					...
					<div className="p-6">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
							...
							<StepCard
								...
								description="Нажмите кнопку «Очистить порт» в интерфейсе. Загрязнения на торцах коннекторов приводят к завышенным потерям и погрешностям измерения."
							/>
							<StepCard
								number="3"
								...
								description={
									<>
										...
										пункт меню <b>Настройка</b>, затем <b>FasTest</b>. Текущая
										настройка помечается синей рамкой. Чтобы изменить значение
										необходимо нажать <b>Enter</b> на клавиатуре прибора.
										Навигация между параметрами также осуществляется с помощью
										клавиш <b>Вверх</b> и <b>Вниз</b>. Параметры, которые
										необходимо установить:
										<ul className="mt-1 space-y-0.5 list-none">
											<li>
												<span className="text-blue-600 font-semibold">•</span>{' '}
												Порт FasTest: <b>Одномодовый (SM)</b>
											</li>
											<li>
												<span className="text-blue-600 font-semibold">•</span>{' '}
												Единица длины: <b>м (метры)</b>
											</li>
											<li>
												<span className="text-blue-600 font-semibold">•</span>{' '}
												Длины волн: <b>1310 нм</b> и <b>1550 нм</b>
											</li>
										</ul>
									</>
								}
				...
				<div className="bg-white rounded-lg shadow-md overflow-hidden">
					...
					<div className="p-6">
						<p className="text-sm text-gray-600 mb-4">
							...
							выполняете три измерения затухания.
						</p>
						<div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
							<StepCard
								number="1"
								title="Выбор компонента"
								description="Выберите один из доступных пассивных компонентов. По умолчанию выбран первый."
								accentColor="emerald"
							/>
							<StepCard
								number="2"
				...
				<div className="bg-white rounded-lg shadow-md overflow-hidden">
					...
					<div className="p-6">
						...
						<div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
							<div className="text-sm text-blue-800">
								<span className="font-semibold">Справочные значения:</span>{' '}
								затухание одномодового волокна при 1310 нм составляет ≤ 0,35
								дБ/км, при 1550 нм — ≤ 0,20 дБ/км. Потери сплиттера 1:N
								теоретически равны 10·lg(N) дБ.
							</div>
						</div>
					</div>
				</div>
