...
const VFL_STEPS: VflStep[] = [
	...
	},
	{
		...
		description:
			'Нажмите кнопку MENU на приборе, перейдите к пункту «Источник/VFL/Видеомикроскоп» с помощью кнопок UP/DOWN и подтвердите выбор кнопкой ENTER.'
	},
	{
		id: 'select_vfl_mode',
		title: 'Перейдите в режим VFL',
		description:
			'В меню «Источник/VFL/Видеомикроскоп» выберите пункт «VFL» с помощью кнопок UP/DOWN и нажмите ENTER.'
	},
	{
		id: 'enable_vfl',
		title: 'Включите VFL',
