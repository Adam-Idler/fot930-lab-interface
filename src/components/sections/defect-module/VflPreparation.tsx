...
const VFL_STEPS: VflStep[] = [
	...
	{
		id: 'open_menu',
		title: 'Откройте меню «Источник/VFL/Видеомикроскоп»',
		description:
			'Нажмите кнопку Menu на приборе, перейдите к пункту «Источник/VFL/Видеомикроскоп» с помощью кнопок Вверх/Вниз и подтвердите выбор кнопкой Enter.'
	},
	{
		id: 'select_vfl_mode',
		title: 'Перейдите в режим VFL',
		description:
			'В меню «Источник/VFL/Видеомикроскоп» выберите пункт «VFL» с помощью кнопок Вверх/Вниз и нажмите Enter.'
	},
	{
		id: 'enable_vfl',
		title: 'Включите VFL',
